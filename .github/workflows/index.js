...
const dbConfig = {
    // cambiar el host
    host: process.env.DB_HOST || 'database-1.cfm6mce8ynro.us-east-2.rds.amazonaws.com',
    user: process.env.DB_USER || 'admin',
    password: process.env.DB_PASSWORD || 'santy1085907981',
    database: process.env.DB_NAME || 'databaseLambda_Santy',
